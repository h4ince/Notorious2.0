    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.listening) {
            if (font.isEnabled()) {
                ...
                Minecraft.func_71410_x().field_71466_p.func_175063_a("Bind: Listening...", this.x + 9.0f, this.y + 1.0f, new Color(255, 255, 255).getRGB());
            }
        }
            ...
            Minecraft.func_71410_x().field_71466_p.func_175063_a("Bind: <" + Keyboard.getKeyName(this.setting.getBind()) + ">", this.x + 9.0f, this.y + 1.0f, new Color(255, 255, 255).getRGB());
        }
    }
